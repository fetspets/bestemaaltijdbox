...
export const aanbieders: Aanbieder[] = [
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      hoeWerktHet: 'Bestellen via crowdcooks.be. Kies wekelijks uit 12 nieuwe gerechten. Bezorging is gratis op zondag of maandag in onder meer Brussel, Vlaams- en Waals-Brabant, Luik, Charleroi, Namen, Gent en Antwerpen. De maaltijden zijn 5 dagen houdbaar in de koelkast en klaar in een paar minuten. Flexibel abonnement: pauzeren of annuleren met één klik.',
      vergelijking: 'Crowd Cooks speelt in hetzelfde kant-en-klaar-segment als Factor, maar is Belgisch en bezorgt gratis, daar waar Factor bezorgkosten aanrekent. Tegenover klassieke kookboxen zoals HelloFresh of Foodbag bespaart Crowd Cooks alle kooktijd, maar je levert wel de kookbeleving en een deel van de receptkeuze in.',
      eindoordeel: 'Crowd Cooks vult een andere behoefte dan de klassieke maaltijdboxen: eten zonder koken, met Belgische verankering en gratis bezorging als troeven. Voor wie tijd de grootste schaarste is en toch verse, royale maaltijden wil, is het een sterk alternatief voor restaurant of take-away.',
    },
    ranking: 9,
    score: { totaal: 7.4, smaak: 7.6, prijsKwaliteit: 6.8, flexibiliteit: 8.0, duurzaamheid: 6.5, gemak: 9.3 },
    prijsPerPortie: 12.48,
    ...
    kortingsCode: {
      code: '60C',
      bedrag: '€60 totaal',
      beschrijving: 'Gebruik code 60C bij je eerste bestelling: €20 korting in week 1 + €10 korting per week gedurende 4 weken. Totale besparing: €60.',
    },
    ctaSubtekst: 'Code: 60C — tot €60 korting',
    kenmerken: ['⚡ Kant-en-klaar', '🇧🇪 Belgisch', '✓ Gratis bezorging', '🍽️ 450+ g per maaltijd'],
    pros: ['Geen koken vereist — enkel opwarmen', 'Gratis bezorging op zondag of maandag', 'Belgische service met royale porties (450+ g)', 'Flexibel: pauzeren of annuleren met één klik'],
    cons: ['Premium prijs per portie', 'Beperktere keuze (12 gerechten per week)', 'Minder culinaire beleving dan een kookbox'],
