...
export const aanbieders: Aanbieder[] = [
  {
    ...
    uitgebreideReview: {
      ...
      voorWie: 'HelloFresh is de beste keuze voor koppels en gezinnen die weinig tijd hebben maar toch gevarieerd willen eten. Dankzij de grote receptvariatie (40+) vinden ook kieskeurige eters altijd iets naar hun smaak.',
