...
kenmerken: ['🇧🇪 Lokale ingrediënten', '✓ Gratis bezorging', '✓ 5 kookstijlen', '✓ Zonder abonnement', '🔀 Voorheen ook Smartmat & 15gram'],    pros: ['100% Belgische en lokale ingrediënten', 'Uitstekende smaakscores', 'Eigen bezorgers', '5 kookstijlen incl. Sana (Sandra Bekkari)', 'Geen verplicht abonnement'],
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      voorWie: 'Carrefour Simply You is de beste keuze voor studenten en gezinnen met een strak budget. Ideaal als eerste kennismaking met maaltijdboxen, zonder abonnementsrisico.',
    ...
    pros: ['Geen verplicht abonnement', '€20 welkomstkorting (code BOXNL20)', 'Bezorging in heel België incl. Wallonië', '10-14 recepten per week'],
  ...
  },
  {
    ...
    naam: 'Veganbox',
    logo: '🌱',
    tagline: 'De enige 100% Belgische vegan maaltijdbox',
    beschrijving: 'Veganbox is de enige volledig plantaardige maaltijdbox van België. Met verse ingrediënten, gratis bezorging in Vlaanderen en geen verplicht abonnement is het dé keuze voor vegans en flexitariërs.',
    uitgebreideReview: {
      intro: 'Veganbox vult een unieke niche in de Belgische maaltijdboxmarkt: 100% plantaardig, zonder compromissen. Als enige volledig vegan maaltijdbox van België richt Veganbox zich op bewuste consumenten die geen dierlijke producten willen maar toch gevarieerd willen eten.',
      testervaring: 'Veganbox biedt 6 nieuwe plantaardige recepten per week. De focus ligt op seizoensgebonden groenten en lokale ingrediënten. Bereidingstijd: 30-45 minuten. Bezorging op maandagavond in heel Vlaanderen.',
      voorWie: 'Veganbox is de perfecte keuze voor vegans, vegetariërs en flexitariërs die minder vlees willen eten. Ook geschikt voor mensen met lactose- of ei-intolerantie.',
      hoeWerktHet: 'Bestellen via veganbox.be. Geen verplicht abonnement — bestel wanneer je wil. 6 recepten per week om uit te kiezen. Gratis bezorging op maandagavond in heel Vlaanderen.',
      vergelijking: 'Veganbox is de enige volledig vegan maaltijdbox in België. Ten opzichte van Ekomenu (100% bio maar niet exclusief vegan) biedt Veganbox een stricter plantaardig aanbod. HelloFresh en Foodbag hebben vegetarische opties maar zijn niet exclusief vegan.',
      eindoordeel: 'Veganbox is een absolute aanrader voor vegans en vegetariërs in Vlaanderen. De unieke positionering en betaalbare prijzen maken het een sterke keuze in het Belgische maaltijdboxlandschap.',
    },
    ranking: 6,
    score: { totaal: 7.4, smaak: 7.5, prijsKwaliteit: 7.8, flexibiliteit: 7.0, duurzaamheid: 8.5, gemak: 7.5 },
    prijsPerPortie: 4.47,
    prijsPopulaireBox: 44.00,
    receptenPerWeek: 6,
    gratisBezorging: true,
    minPersonen: 2,
    maxPersonen: 4,
    ...
    vegetarisch: true,
    bio: false,
    affiliateUrl: 'https://www.veganbox.be',
    kenmerken: ['🌱 100% Vegan', '🇧🇪 Belgisch', '✓ Geen abonnement', '✓ Gratis bezorging'],
    pros: ['Enige 100% vegan maaltijdbox in België', 'Geen verplicht abonnement', 'Gratis bezorging in Vlaanderen', 'Betaalbaar (v.a. €4,47/portie)'],
    cons: ['Beperkt aanbod (6 recepten/week)', 'Enkel Vlaanderen (niet Wallonië of Brussel)', 'Minder receptvariatie dan HelloFresh'],
    geschiktVoor: ['vegetarisch', 'koppel'],
  },
  {
    slug: 'factor',
    naam: 'Factor',
