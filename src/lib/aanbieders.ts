...
export const aanbieders: Aanbieder[] = [
  {
    ...
    uitgebreideReview: {
      ...
      eindoordeel: 'HelloFresh verdient zijn #1 positie. De combinatie van prijs, variatie en gemak is ongeëvenaard in België. Zeker met de welkomstkorting van tot €90 is het een no-brainer om te proberen.',
    },
    ranking: 1,
  ...
  },
  {
    ...
    pros: ['100% Belgische en lokale ingrediënten', 'Uitstekende smaakscores', 'Eigen bezorgers', '5 kookstijlen incl. Sana (Sandra Bekkari)', 'Geen verplicht abonnement'],
  ...
  },
  {
    ...
    naam: 'Smartmat',
    logo: '⚡',
    tagline: 'Gefusioneerd met Foodbag',
    beschrijving: 'Smartmat bestaat niet meer als aparte maaltijdbox. Het merk is volledig gefusioneerd met Foodbag, dat nu verder gaat als de premium Belgische maaltijdbox van de Colruyt Group.',
    uitgebreideReview: {
      intro: 'Smartmat was een populaire Belgische maaltijdbox bekend voor zijn snelle recepten klaar in 20 minuten. In 2019 fusioneerde Smartmat met Foodbag en bestaat het niet meer als aparte dienst.',
      testervaring: 'Smartmat bestaat niet meer als aparte maaltijdbox. De snelle recepten en het concept zijn verder gegaan onder de naam Foodbag, dat nu een "Quick & Easy" lijn aanbiedt met vergelijkbare snelle gerechten.',
      voorWie: 'Was je fan van Smartmat? Dan is Foodbag de beste keuze — hetzelfde concept, betere ingrediënten en meer receptvariatie.',
      hoeWerktHet: 'Smartmat is gefusioneerd met Foodbag. Je kan nu bestellen via foodbag.be waar je dezelfde snelle recepten kan vinden onder de "Quick & Easy" lijn.',
      vergelijking: 'Foodbag is de opvolger van Smartmat met betere lokale ingrediënten en meer receptkeuze. HelloFresh is een goed alternatief als je op zoek bent naar een goedkopere optie.',
      eindoordeel: 'Smartmat bestaat niet meer. We raden Foodbag aan als de beste Belgische opvolger, of HelloFresh als je een goedkopere internationale optie verkiest.',
    },
    ranking: 8,
    score: { totaal: 0, smaak: 0, prijsKwaliteit: 0, flexibiliteit: 0, duurzaamheid: 0, gemak: 0 },
    prijsPerPortie: 0,
    prijsPopulaireBox: 0,
    receptenPerWeek: 0,
    gratisBezorging: true,
    minPersonen: 2,
    maxPersonen: 5,
    opzegTermijn: 'Niet meer beschikbaar',
    belgisch: true,
    vegetarisch: false,
    bio: false,
    affiliateUrl: 'https://www.foodbag.be/foodbox/?tt=19934_1015100_507243_&r=',
    kenmerken: ['⚠️ Niet meer actief', '🔀 Gefusioneerd met Foodbag'],
    pros: ['Was bekend voor snelle recepten (20 min)', 'Lokale Belgische ingrediënten'],
    cons: ['Bestaat niet meer als aparte maaltijdbox', 'Volledig gefusioneerd met Foodbag'],
    geschiktVoor: [],
  },
];
