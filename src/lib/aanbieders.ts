...
export const aanbieders: Aanbieder[] = [
  {
    ...
    uitgebreideReview: {
      ...
      voorWie: 'HelloFresh is een sterke keuze voor koppels en gezinnen die weinig tijd hebben maar toch gevarieerd willen eten. Dankzij de grote receptvariatie (40+) vinden ook kieskeurige eters altijd iets naar hun smaak.',
...
kenmerken: ['🇧🇪 Lokale ingrediënten', '✓ Gratis bezorging', '✓ 5 kookstijlen', '✓ Zonder abonnement', '🔀 Voorheen ook Smartmat & 15gram'],    pros: ['100% Belgische en lokale ingrediënten', 'Uitstekende smaakscores', 'Eigen bezorgers', '5 kookstijlen incl. Sana (Sandra Bekkari)', 'Geen verplicht abonnement'],
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      voorWie: 'Marley Spoon is een goede keuze voor koppels of alleenstaanden die van koken houden en de tijd nemen voor een uitgebreidere bereiding.',
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      voorWie: 'Ekomenu is een goede keuze voor milieubewuste consumenten, vegetariërs en vegans in Vlaanderen en Brussel. Ook interessant voor mensen met voedselallergieën dankzij de uitgebreide filteropties.',
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      eindoordeel: 'Foodmaker is een interessante kant-en-klare keuze voor wie van kwaliteit en Belgische smaak houdt. De samenwerking met Jeroen Meus geeft het een herkenbaar en vertrouwd karakter.',
    },
    ranking: 5,
