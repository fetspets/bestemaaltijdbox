...
export const aanbieders: Aanbieder[] = [
  {
    ...
    beschrijving: 'HelloFresh is de populairste maaltijdbox in België en wereldwijd. Met meer dan 50 recepten per week, gratis bezorging en een flexibel abonnement biedt het een uitstekende balans tussen prijs, keuze en gemak.',
    uitgebreideReview: {
