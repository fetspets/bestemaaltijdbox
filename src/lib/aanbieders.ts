...
export const aanbieders: Aanbieder[] = [
  {
    ...
    uitgebreideReview: {
      intro: 'HelloFresh is de absolute marktleider in België en dat is niet zonder reden. Uit ons uitgebreid onderzoek en de brede gebruikerservaringen blijkt dat geen enkele andere box zo\'n goede balans biedt tussen prijs, variatie en gebruiksgemak. Of je nu kookt voor 2 of voor een heel gezin — HelloFresh past zich aan.',
      testervaring: 'Op basis van uitgebreide gebruikerservaringen en publieke data scoort HelloFresh consistent goed op bezorging: vlot, gekoeld en op tijd. De receptkaarten zijn duidelijk met stap-voor-stap instructies en foto\'s. Bereidingstijd schommelt tussen 25 en 45 minuten. Wat opvalt uit de reviews: de variatie is indrukwekkend. Van Belgische klassiekers tot Aziatische wokgerechten en van vegetarisch tot vis — het aanbod is breed en gevarieerd. Porties zijn goed afgemeten met weinig verspilling.',
...
kenmerken: ['🇧🇪 Lokale ingrediënten', '✓ Gratis bezorging', '✓ 5 kookstijlen', '✓ Zonder abonnement', '🔀 Voorheen ook Smartmat & 15gram'],    pros: ['100% Belgische en lokale ingrediënten', 'Uitstekende smaakscores', 'Eigen bezorgers', '5 kookstijlen incl. Sana (Sandra Bekkari)', 'Geen verplicht abonnement'],
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      testervaring: 'Uit gebruikerservaringen en reviews vallen de recepten van Marley Spoon op door hun originaliteit en smaakdiepte. Recepten kosten gemiddeld 45-60 minuten — Marley Spoon mikt op mensen die van koken genieten. De ingrediënten zijn vers en kwalitatief. Minpunt: Marley Spoon bezorgt momenteel enkel in Vlaanderen en Brussel, niet in Wallonië.',
  ...
  },
  {
    ...
    uitgebreideReview: {
      ...
      testervaring: 'Uit gebruikerservaringen blijkt het Cirkle-systeem goed te werken: bij levering geef je de lege verpakkingen terug. De biologische ingrediënten zijn van goede kwaliteit. De recepten zijn lekker maar minder gevarieerd (10/week). Beschikbaarheid beperkt tot Vlaanderen.',
