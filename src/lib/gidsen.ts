...
export const gidsen: Gids[] = [
  {
    ...
    faq: [
      ...
      { q: 'Welke maaltijdbox is goedkoopst voor nieuwe klanten?', a: 'HelloFresh geeft €50 korting op je eerste 4 boxen via code HELLO85FL. Foodbag geeft €60 korting via code FOODBAGx60 (3x €20), Marley Spoon tot 35% korting op je eerste 5 boxen, en Carrefour Simply You €20 korting via code BOXNL20.' },
