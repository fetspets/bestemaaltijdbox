...
export const vergelijkingen: Vergelijking[] = [
  ...
  },
  {
    ...
    verdictTekst: 'Crowd Cooks en Factor zitten allebei in het kant-en-klaar-segment: je kookt niet, je warmt op. Het grote verschil zit in de prijsopbouw en de verankering. Crowd Cooks is Belgisch en rekent €4,90 bezorgkosten op zondag of maandag, terwijl Factor (van de HelloFresh Group) €5,99 per levering aanrekent — lager bij Crowd Cooks, maar in beide gevallen telt het op bij regelmatig gebruik. Factor biedt meer keuze (18 gerechten per week tegenover 12) en vijf uitgesproken dieetstijlen, wat interessant is voor sporters en wie caloriebewust eet. Wie de laagste totaalprijs en de grootste variatie wil, leunt richting Factor. Wie bewust Belgisch wil eten, royale porties zoekt en lagere bezorgkosten wil, kiest Crowd Cooks.',
    faq: [
