          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {[
                ...
                { label: 'Factor vs HelloFresh', href: '/vergelijk/factor-vs-hellofresh' },
                { label: 'Factor vs Foodbag', href: '/vergelijk/factor-vs-foodbag' },
                { label: 'Factor vs Marley Spoon', href: '/vergelijk/factor-vs-marley-spoon' },
