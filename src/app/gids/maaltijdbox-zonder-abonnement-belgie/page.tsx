...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://bestemaaltijdbox.be/gids/maaltijdbox-zonder-abonnement-belgie' },
  openGraph: {
    title: 'Maaltijdbox zonder abonnement in België 2026 — opties vergeleken',
    description: 'Geen abonnement maar toch een maaltijdbox? Bekijk welke Belgische aanbieders leveren zonder vast contract. Vergelijk prijs en bespaar.',
    url: 'https://bestemaaltijdbox.be/gids/maaltijdbox-zonder-abonnement-belgie',
    type: 'article',
    locale: 'nl_BE',
  },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Maaltijdbox zonder abonnement', item: 'https://bestemaaltijdbox.be/gids/maaltijdbox-zonder-abonnement-belgie' },
  ],
};
