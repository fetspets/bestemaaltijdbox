...
const kortingen = [
  {
    ...
    bedrag: '€60',
    kleur: '#1B4332',
    beschrijving: 'Gebruik exclusieve code BESTE60 bij je eerste bestelling en bespaar €60. Geldig voor nieuwe klanten.',
    voorwaarden: 'Geldig voor nieuwe klanten · Code: BESTE60 · Direct opzegbaar',
    actief: true,
  },
  {
    slug: 'marley-spoon',
