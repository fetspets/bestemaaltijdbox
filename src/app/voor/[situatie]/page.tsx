...
const situaties: Record<string, {
  ...
  koppel: {
    ...
    faq: [
      { q: 'Welke maaltijdbox is het beste voor 2 personen in België?', a: 'HelloFresh is de populairste keuze voor koppels: groot receptaanbod, gratis bezorging en tot €60 korting op je eerste 3 boxen. Marley Spoon is een goed alternatief voor wie van uitgebreider koken houdt, met tot 50% korting op de eerste 4 boxen.' },
      { q: 'Wat kost een maaltijdbox voor 2 personen per week?', a: 'Reken op €6,18 tot €10,00 per portie, oftewel €37 tot €60 per week voor 3 maaltijden voor 2 personen exclusief bezorgkosten. Met welkomstkorting zijn de eerste weken een stuk goedkoper — HelloFresh geeft tot €60 korting op je eerste 3 boxen en Foodbag €60 korting, automatisch via de link.' },
      { q: 'Welke maaltijdbox voor koppels heeft nu de beste deal?', a: 'Foodbag geeft €60 korting — 3x €20 op je eerste 3 bestellingen, automatisch via de link, geldig tot 01/01/2027. HelloFresh geeft tot €60 korting verdeeld over je eerste 3 boxen, automatisch via de link.' },
