...
const situaties: Record<string, {
  ...
  koppel: {
    ...
    faq: [
      { q: 'Welke maaltijdbox is het beste voor 2 personen in België?', a: 'HelloFresh is de populairste keuze voor koppels: groot receptaanbod, gratis bezorging en gratis GreenPan™ t.w.v. tot €119,90 + tot €60 korting (actie t.e.m. 15 juni 2026). Marley Spoon is een goed alternatief voor wie van uitgebreider koken houdt, met tot 35% korting op de eerste 5 boxen.' },
      { q: 'Wat kost een maaltijdbox voor 2 personen per week?', a: 'Reken op €6,18 tot €10,00 per portie, oftewel €37 tot €60 per week voor 3 maaltijden voor 2 personen exclusief bezorgkosten. Met welkomstkorting zijn de eerste weken een stuk goedkoper — HelloFresh geeft tot €60 korting + gratis GreenPan™ t.w.v. tot €119,90 (actie t.e.m. 15 juni 2026) en Foodbag €60 korting (code FOODBAGx60).' },
      { q: 'Welke maaltijdbox voor koppels heeft nu de beste deal?', a: 'Foodbag geeft €60 korting via code FOODBAGx60 — 3x €20 op je eerste 3 bestellingen, geldig tot 01/01/2027. HelloFresh geeft gratis GreenPan™ t.w.v. tot €119,90 + tot €60 korting (actie t.e.m. 15 juni 2026).' },
      ...
      {gefilterd.map((a, i) => {
        ...
        return (
          <div key={a.slug} style={{
            ...
            <div className="specs-grid" style={{ border: '1px solid var(--rule)', borderRadius: 10, overflow: 'hidden', fontSize: 12, marginBottom: 14 }}>
              {[
