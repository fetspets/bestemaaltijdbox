...
const situaties: Record<string, {
  ...
  koppel: {
    ...
    faq: [
      ...
      { q: 'Welke maaltijdbox voor koppels heeft nu de beste deal?', a: 'Foodbag geeft €60 korting via code FOODBAGx60 — 3x €20 op je eerste 3 bestellingen, geldig tot 01/01/2027. HelloFresh geeft tot €60 korting verdeeld over je eerste 3 boxen, automatisch via de link.' },
