...
export const metadata: Metadata = {
  ...
  description: 'Op zoek naar een 100% vegan maaltijdbox in België? Ekomenu (volledig plantaardig & bio) vergeleken met de vegan-opties van HelloFresh en Foodbag.',
